...
export default function PortalLayoutClient({ children }: { children: React.ReactNode }) {
  ...
  const menuItems = {
    client: [
      ...
      { name: "Officer Chat", path: "/portal/client/messages", icon: MessageSquare }
    ],
    admin: [
      { name: "Client Pipelines", path: "/portal/admin", icon: Users },
      { name: "Verify Documents", path: "/portal/admin/verify", icon: Shield },
      { name: "Consular Partner Gateway", path: "/portal/admin/gateway", icon: Building },
    ...
    superadmin: [
      ...
      { name: "API Gateways", path: "/portal/superadmin/integrations", icon: CreditCard },
      { name: "Partnership Requests", path: "/portal/superadmin/partnerships", icon: Building },
      { name: "Security Audit Logs", path: "/portal/superadmin/security", icon: Shield }
    ]
  };
